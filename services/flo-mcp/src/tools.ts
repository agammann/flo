...
export const createFloMcpServer = (orchestrator: FloOrchestrator, actor: Actor, options: { demoMode?: boolean } = {}): McpServer => {
  ...
  server.registerTool("get_work_order", {
    ...
    inputSchema: z.object({ idOrNumber: z.string().min(1) }), outputSchema: toolOutputSchemas.workOrder, annotations: readOnly
  ...
  server.registerTool("list_open_work_orders", {
    ...
    inputSchema: z.object({}), outputSchema: toolOutputSchemas.workOrders, annotations: readOnly
  ...
  server.registerTool("search_work_orders", {
    ...
    inputSchema: z.object({ query: z.string().min(1) }), outputSchema: toolOutputSchemas.workOrders, annotations: readOnly
  ...
  server.registerTool("add_work_order_note", {
    ...
    inputSchema: optionalWorkOrder.extend({ note: z.string().min(1).max(2000) }), outputSchema: toolOutputSchemas.workOrder, annotations: internalMutation
  ...
  server.registerTool("get_asset", {
    ...
    inputSchema: optionalWorkOrder, outputSchema: toolOutputSchemas.asset, annotations: readOnly
  ...
  server.registerTool("record_diagnostic", {
    ...
    inputSchema: optionalWorkOrder.extend({ finding: z.string().min(1).max(2000) }), outputSchema: toolOutputSchemas.diagnostic, annotations: internalMutation
  ...
  server.registerTool("get_diagnostic_history", {
    ...
    inputSchema: optionalWorkOrder, outputSchema: toolOutputSchemas.diagnostics, annotations: readOnly
  ...
  server.registerTool("search_parts", {
    ...
    inputSchema: z.object({ category: z.string().min(1).optional(), query: z.string().min(1).optional() }), outputSchema: toolOutputSchemas.parts, annotations: readOnly
  ...
  server.registerTool("check_part_compatibility", {
    ...
    inputSchema: optionalWorkOrder.extend({ partIdOrNumber: z.string().min(1) }), outputSchema: toolOutputSchemas.compatibility, annotations: readOnly
  ...
  server.registerTool("search_inventory", {
    ...
    inputSchema: z.object({ partId: z.string().min(1).optional() }), outputSchema: toolOutputSchemas.inventory, annotations: readOnly
  ...
  server.registerTool("search_suppliers", {
    ...
    inputSchema: z.object({ partIds: z.array(z.string().min(1)).min(1), latestDeliveryDate: z.iso.date().optional(), maximumLandedCostCents: z.number().int().nonnegative().optional() }), outputSchema: toolOutputSchemas.supplierSearch, annotations: { ...readOnly, openWorldHint: true }
  ...
  server.registerTool("calculate_estimate", {
    ...
    inputSchema: optionalWorkOrder.extend({ supplierSku: z.string().min(1).optional(), laborHours: z.number().nonnegative().optional() }), outputSchema: toolOutputSchemas.estimate, annotations: readOnly
  ...
  server.registerTool("create_estimate", {
    ...
    inputSchema: optionalWorkOrder.extend({ supplierSku: z.string().min(1).optional(), laborHours: z.number().nonnegative().optional() }), outputSchema: toolOutputSchemas.estimate, annotations: internalMutation
  ...
  server.registerTool("get_estimate", {
    ...
    inputSchema: z.object({ idOrWorkOrderId: z.string().min(1).optional() }), outputSchema: toolOutputSchemas.estimate, annotations: readOnly
  ...
  server.registerTool("get_customer", {
    ...
    inputSchema: optionalWorkOrder, outputSchema: toolOutputSchemas.customer, annotations: readOnly
  ...
  server.registerTool("send_customer_message", {
    ...
    inputSchema: optionalWorkOrder.extend({ body: z.string().min(1).max(2000) }), outputSchema: toolOutputSchemas.customerMessage, annotations: externalMutation
  ...
  server.registerTool("request_customer_approval", {
    ...
    inputSchema: optionalWorkOrder, outputSchema: toolOutputSchemas.approval, annotations: { ...externalMutation, idempotentHint: true }
  ...
  server.registerTool("get_customer_approval_status", {
    ...
    inputSchema: z.object({ reference: z.string().min(1).optional() }), outputSchema: toolOutputSchemas.approval, annotations: internalMutation
  ...
  if (demoMode) {
    server.registerTool("simulate_customer_approval", {
      ...
      inputSchema: z.object({ status: z.enum(["approved", "denied"]), approvalId: z.string().min(1).optional() }), outputSchema: toolOutputSchemas.approval, annotations: internalMutation
  ...
  server.registerTool("get_schedule", {
    ...
    inputSchema: z.object({ bayId: z.string().min(1).optional(), from: dateTime.optional(), to: dateTime.optional() }), outputSchema: toolOutputSchemas.schedule, annotations: readOnly
  ...
  server.registerTool("find_available_slot", {
    ...
    inputSchema: z.object({ bayId: z.string().min(1), start: dateTime, end: dateTime }), outputSchema: toolOutputSchemas.slotAvailability, annotations: readOnly
  ...
  server.registerTool("prepare_purchase_and_schedule", {
    ...
    inputSchema: optionalWorkOrder.extend({ bayId: z.string().min(1), start: dateTime, end: dateTime, supplierSku: z.string().min(1).optional(), idempotencyKey: z.string().min(8).optional() }), outputSchema: toolOutputSchemas.transactionPreparation, annotations: internalMutation
  ...
  server.registerTool("confirm_transaction", {
    ...
    inputSchema: z.object({ confirmationToken: z.string().uuid() }), outputSchema: toolOutputSchemas.transactionResult, annotations: externalMutation
  ...
  server.registerTool("get_order_status", {
    ...
    inputSchema: z.object({ idOrIdempotencyKey: z.string().min(1) }), outputSchema: toolOutputSchemas.purchaseOrder, annotations: { ...readOnly, openWorldHint: true }
  ...
  server.registerTool("get_job_status", {
    ...
    inputSchema: z.object({ reference: z.string().min(1).default("active job") }), outputSchema: toolOutputSchemas.jobStatus, annotations: readOnly
  ...
  if (demoMode) {
    server.registerTool("get_demo_time_window", {
      ...
      inputSchema: z.object({}), outputSchema: toolOutputSchemas.demoTimeWindow, annotations: readOnly
    ...
    server.registerTool("reset_demo", {
      ...
      inputSchema: z.object({ confirmation: z.literal("RESET FLO DEMO") }), outputSchema: toolOutputSchemas.demoReset, annotations: { ...externalMutation, openWorldHint: false }
